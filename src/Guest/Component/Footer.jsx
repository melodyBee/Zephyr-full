          ...
          <div className="row">
            ...
            <div className="col-4 col-lg-2 offset-lg-1 mb-3">
              ...
              <ul className="list-unstyled">
                ...
                <li className="mb-2">
                  <Link to="/SignLog">SignUp/Login</Link>
                </li>
              </ul>
            </div>
            ...
            <div className="col-4 col-lg-2 mb-3">
              ...
              <ul className="list-unstyled">
                <li className="mb-2">
                  <Link to="https://melodybee.github.io/GlamTrove/">
                    GlamTrove
                  </Link>
                </li>
                <li className="mb-2">
                  <Link to="https://melodybee.github.io/calculator-js/">
                    Calculator
                  </Link>
                </li>
                <li className="mb-2">
                  <Link to="https://todo-app-one-eta.vercel.app/">
                    Todo App
                  </Link>
                </li>
              </ul>
